...
**Messaging** handles coordination—private, censorship-resistant communication between parties. It consists of two layers [Logos Delivery](https://github.com/logos-messaging/logos-delivery) provides the transport—publish-subscribe messaging, reliable delivery; [Logos Chat](https://github.com/logos-messaging/nim-chat-poc) uses Delivery as transport, providing encrypted 1:1 conversations, and evolving toward group conversations. Both are being packaged as separate Logos Core modules—a [Delivery module](https://github.com/logos-co/logos-delivery-module) and a [Chat module](https://github.com/logos-co/logos-chatsdk-module). Chat module currently embeds Delivery directly; future versions will use the standalone module through kernel's IPC.
