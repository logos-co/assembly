...
*Buffer: can be shortened to 15 min if Session 1 overruns*
...
**Owner:** Jarrad, Kaushal, Ksr, Jonny
**Format:** Panel presentation → live reveal → moderated Q&A
...
*Location: [TBD — Melanie/Terry to confirm]*
*Buffer: can be shortened to 15 min if Session 3 overruns*
...
**Owner:** Stream leads for questions; Leadership for synthesis; TBD for closing
**Format:** Facilitated table discussions + sharebacks → stage presentation → closing moment
...
|---------|---------|-------|-----------|
| Session 1: What is Logos + Nimbus + Status | Yes | Yes | Canonical explanation + project showcases — onboarding & comms material |
| Session 2: Roadmap Panel + Testnet Reveal | Yes | Yes | Landmark moment — internal reference + potential external use |
| Session 3: Who We're Building For + Showcases | Yes | Yes | Movement storytelling + demos = recruitment/comms material |
| Session 4: Key Questions | No | — | Internal working session, not for recording |
| Session 4: Closing (The Charge) | Maybe | Maybe | Depends if there's a shareable moment |
